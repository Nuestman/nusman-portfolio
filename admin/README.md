...
Private workbench for the nusman.dev practice, plus the client portal. Version **2.5.0**. Plan: [../docs/desk-2.0.md](../docs/desk-2.0.md). Portal: [../docs/portal.md](../docs/portal.md). Status: [../docs/desk-status.md](../docs/desk-status.md). Visual: [../docs/style-guide.md](../docs/style-guide.md).
...
npm run db:migrate    # through 0013_client_source_expand.sql
