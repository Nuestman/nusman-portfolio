import type { LegalSection } from "./legal-documents";

/**
 * Seed copy for site_legal_documents — keep aligned with
 * src/content/privacy.ts and src/content/terms.ts (Vite fallback).
 */
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Address: AN758, Ivory Street, MVSS 27, Moinsi Valley Estate. For privacy requests, complaints, or questions (including data subject rights and Data Protection Commission matters), please use the contact details on this page.",
      ...
      },
      {
        ...
        title: "14. Contact",
        paragraphs: [
          "Nuestman Tech Solutions, AN758, Ivory Street, MVSS 27, Moinsi Valley Estate. For privacy, data subject rights, or Data Protection Commission–related enquiries, use the contact details on this page or email nuestman@icloud.com.",
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "14. Contact",
        paragraphs: [
          "For questions about these Terms, contact Nuestman Tech Solutions (registered as Nuestman Links Enterprise with Ghana ORC and DPC) at AN758, Ivory Street, MVSS 27, Moinsi Valley Estate, email nuestman@icloud.com, or phone +233 20 648 4034.",
        ],
      },
    ],
  },
