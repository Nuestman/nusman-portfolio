...
Supersedes the “kitchen sink project page” behaviour of Desk **1.3.0**. Prior snapshots: [archive/desk-1.1.md](./archive/desk-1.1.md). Live status: [desk-status.md](./desk-status.md) (**2.0.0**). Detail still useful in [desk.md](./desk.md) and [portal.md](./portal.md); **this file wins** where they conflict.
...
Ship / deploy Desk **2.0.0** when ready. Further work is ordinary product iteration (calendar sync, Today refinements, etc.), not this cut.
