...
Supersedes the “kitchen sink project page” behaviour of Desk **1.3.0**. Prior snapshots: [archive/desk-1.1.md](./archive/desk-1.1.md). Live status: [desk-status.md](./desk-status.md) (**2.7.1**). Detail still useful in [desk.md](./desk.md) and [portal.md](./portal.md); **this file wins** where they conflict.
...
Desk **2.0.0** cut is shipped. Current product version is **2.7.1** ([desk-status.md](./desk-status.md), [changelog.md](./changelog.md)). Further work is ordinary product iteration (routing cleanup, calendar sync, Today refinements, etc.), not this cut.
